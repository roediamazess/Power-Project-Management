...
<aside class="pe-app-sidebar horizontal-sidebar d-none" id="horizontal-aside">
    <div class="pe-app-horizontal-logo d-flex align-items-center">
        <img height="30" class="pe-app-sidebar-logo-default d-none" alt="Logo" src="/assets/images/logo-custom.png">
        <img height="30" class="pe-app-sidebar-logo-light d-none" alt="Logo" src="/assets/images/logo-custom.png">
        <img height="30" class="pe-app-sidebar-logo-minimize d-none" alt="Logo" src="/assets/images/logo-custom.png">
        <img height="30" class="pe-app-sidebar-logo-minimize-light d-none" alt="Logo" src="/assets/images/logo-custom.png">
    </div> 
