            ...
            <div class="flex-shrink-0 d-flex align-items-center gap-1">
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    ...
                    <div class="dropdown-menu dropdown-mega-md header-dropdown-menu pe-noti-dropdown-menu p-0">
                        ...
                        <div class="p-3">
                            <div class="noti-item">
                                <img src="/assets/images/logo-custom.png" alt="Logo Image" class="avatar-md d-none">
                                <div>
                            ...
                            <div class="noti-item">
                                <img src="/assets/images/avatar/avatar-2.jpg" alt="Avatar Image" class="avatar-md">
                                <div>
                                    <a href="javascript:void(0)" class="stretched-link">
                                        <h6 class="mb-1">New Message</h6>
                                    </a>
                                    <p class="text-muted mb-2">You have received a new message from John Doe.</p>
                                </div>
                            </div>
                            <div class="noti-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-2">Your system has been updated to the latest version.</p>
                                </div>
                            </div>
                            <div class="noti-item">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-2">Unusual login activity detected on your account.</p>
                                </div>
                            </div>
                        </div>
                        <div class="p-3 border-top">
                            <a href="javascript:void(0)" class="btn btn-primary w-full">View All Notifications</a>
                        </div>
                    </div>
                </div>
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    ...
                    <ul class="dropdown-menu dropdown-mega-md header-dropdown-menu p-0">
                        <li>
                            <div class="p-3 border-bottom">
                                <h6 class="d-flex align-items-center mb-0">Messages <span class="badge bg-primary rounded-circle align-middle ms-1">3</span></h6>
                            </div>
                        </li>
                        <li>
                            <div class="p-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-0">Hey! How are you doing?</p>
                                    </div>
                                    <span class="text-muted fs-12">2 min ago</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="p-3 border-top">
                                <a href="javascript:void(0)" class="btn btn-primary w-full">View All Messages</a>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="dropdown-menu header-dropdown-menu">
                        <li>
                            <div class="p-3">
                                <div class="row g-3">
                                    <div class="col-4">
                                        <a href="apps-chat" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-chat-dots fs-4 text-primary"></i>
                                            <span class="fs-12">Chat</span>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="apps-calendar" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-calendar3 fs-4 text-success"></i>
                                            <span class="fs-12">Calendar</span>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="apps-email" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-envelope fs-4 text-warning"></i>
                                            <span class="fs-12">Email</span>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="dashboard-ecommerce" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-cart3 fs-4 text-info"></i>
                                            <span class="fs-12">Ecommerce</span>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="dashboard-crm" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-people fs-4 text-danger"></i>
                                            <span class="fs-12">CRM</span>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="dashboard-project" class="d-flex flex-column align-items-center gap-2 p-3 border rounded">
                                            <i class="bi bi-kanban fs-4 text-secondary"></i>
                ...
                <div class="dropdown pe-dropdown-mega">
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="pe-2">
                            ...
                            @else
                                ...
                                <span class="d-block mb-0 fs-12 text-muted">—</span>
                            @endauth
                        </div>
                    </button>
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        ...
                        <ul class="list-unstyled mb-1 border-bottom pb-1">
                            <li><a class="dropdown-item" href="/pages-profile"><i class="bi bi-person me-1"></i> View Profile</a></li>
                            <li><a class="dropdown-item" href="/pages-profile-setting"><i class="bi bi-gear me-1"></i> Settings</a></li>
                            <li><a class="dropdown-item" href="/pages-pricing"><i class="bi bi-award me-1"></i> Subscription</a></li>
                        </ul>
                        <ul class="list-unstyled mb-1 border-bottom pb-1">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <form method="POST" action="/logout">
                                    @csrf
                                    <button type="submit" class="dropdown-item"><i class="bi bi-box-arrow-right me-1"></i> Sign Out</button>
                                </form>
                            </li>
                            @else
                            <li><a class="dropdown-item" href="/login"><i class="bi bi-box-arrow-in-right me-1"></i> Sign In</a></li>
                            @endauth
                        </ul>
                    </div>
                </div>
